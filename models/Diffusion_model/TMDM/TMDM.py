...
from .tmdm_model import ConditionalGuidedModel
...
class TMDM(nn.Module):
    ...
    def __init__(self, configs, device):
        ...
        if hasattr(configs, "beta_schedule"):
            diffusion_config.diffusion.beta_schedule = configs.beta_schedule
        if hasattr(configs, "beta_start"):
            diffusion_config.diffusion.beta_start = configs.beta_start
        if hasattr(configs, "beta_end"):
            diffusion_config.diffusion.beta_end = configs.beta_end
